 ...
 * @ass1
 */
public abstract class Aircraft implements OccupancyLevel, Encodable, Tickable, EmergencyState {
     ...
     * @return true if the aircraft equals another aircraft
     */
    @Override
    public boolean equals(Object obj) {
        ...
        return callsign.equals(aircraft.callsign)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(callsign, characteristics);
    }
